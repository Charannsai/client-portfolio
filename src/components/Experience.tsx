...
export default function Experience() {
  return (
    <div className="flex flex-col gap-6 w-full font-sans">
      {experiences.map((exp) => (
        <div key={exp.company} className="flex flex-col gap-1.5 text-left">
          {/* Header Line */}
